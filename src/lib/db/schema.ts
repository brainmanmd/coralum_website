...
export const waitlistSignups = pgTable(
  'waitlist_signups',
  {
    ...
    joiningAs: varchar('joining_as', { length: 20 }).notNull(),
    ...
    parkinsonsDuration: varchar('parkinsons_duration', { length: 50 }).notNull(),
    usesWearable: boolean('uses_wearable').notNull(),
